...
init = function()
	Paddle1.height = Screen_Height / 3
	...
	Ball.width = Screen_Width / 20
	Ball.height = Screen_Height / 20
...
render = function()
    ...
    renderer.fixedText("Player : " .. Score_Player .. "|Computer : " .. Score_Computer, 
        ...
        0, 0, 0, 1) 
		renderer.fixedText("FPS : " .. engine.getFPS(), Screen_Width / 10 * 4, 0, Screen_Width / 10 * 2,
			Screen_Height / 10, 0, 0, 0, 1)
    image.drawRectangle(Ball.x, Ball.y, Ball.width, Ball.height, Ball.image)
    renderer.rectangle(Paddle1.x, Paddle1.y, Paddle1.width, Paddle1.height, 0, 0, 0, 1)
    renderer.rectangle(Paddle2.x, Paddle2.y, Paddle2.width, Paddle2.height, 0, 0, 0, 1)
end

close = function()
	print("Closed")
	image.free(Ball.image)
end

mousePressed = function()
	if Paddle1.y + Paddle1.height / 2 < mouse_y then
		Paddle1.yspeed = 2
	elseif Paddle1.y + Paddle1.height / 2 > mouse_y then
		Paddle1.yspeed = -2
	end
